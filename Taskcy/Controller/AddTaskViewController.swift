...
class AddTaskViewController: UIViewController {
    ...
    func setDatePicker(){
        ...
        dateTextField.text = formatDate(date: Date()) // todays Date
    }
    ...
    @IBAction func addTaskButtonTapped(_ sender: Any) {
        ...
        taskViewModel.addTask(Task(name: taskNameTextField.text!, date: datePicker.date.getDateString(), status: status))
